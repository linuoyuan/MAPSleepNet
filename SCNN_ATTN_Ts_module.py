...
# f_model.load_weights('E:/Lab/EOG_Code/infant_sleep - tf20-2/network/model/multi-group/CNN_ATTN_Ts_ADDLOSS/CHAT/C4/10/fold'
...
# s_model.summary()    
# s_model.load_weights('E:/Lab/EOG_Code/infant_sleep - tf20-2/network/model/multi-group/CNN_ATTN_Ts_ADDLOSS/CHAT/C4/10/fold'
...
def SCNN_ATTN_Ts(model_dir, data_dir):
    s_model.load_weights(model_dir)
